<footer class="page-footer" style="margin-top: 120px; box-shadow: 0px 0px 2px white; background-color: rgb(17,17,17)">
  <div class="row wide-container">
    ...
    <div class="col s2">
      ...
      <p class="bold">
        Douala Akwa Nord, Bafoussam, Yaounde Titi Garage, <br>
        Yaounde Ngousso, Yaounde Odza <br> Douala Bonamoussadi
      </p>
    </div>
    <div class="col s2">
  ...
  <div class="footer-copyright" style="padding-bottom: 20px;">
    <div class="wide-container underline">© 2025 OG Tech PC All rights reserved.</div>
  </div>
