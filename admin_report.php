...
<div class="container" style="margin-top:150px">
	...
	<h3 class="page-title">Rapport hebdomadaire.</h3>
	</div>
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		<h5 style="color:white">Graphique des ventes.</h5>
		<p style="color:white">Graphique des ventes par semaine</p>
		<div>
		...
		<h4 style="color:white">Total de ventes des 7 derniers jours:RM<?php echo $data_tot = number_format((float)$data_tot, 2, '.', '');?></h4>
		<h4 style="color:white">Jour de depart: <?php echo $date7?></h4>
		<h4 style="color:white">Jour de Fin: <?php echo $date1?></h4>
	</div>
	<br><br><br>
	<h3 class="page-title">Rapport Mensuel</h3>
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		<h5 style="color:white">Graphique des ventes</h5>
		<p style="color:white">Graphique des Ventes par Mois</p>
		<div>
		...
		?>
		<h4 style="color:white">Total des Ventes des 90 derniers jours: RM<?php echo $month_tot = number_format((float)$month_tot, 2, '.', '');?></h4>
	</div>
	<br><br><br>
	<div class="row" id="product" name="product"></div>
	<h3 class="page-title">Rapport des articles</h3>
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		<h5 style="color:white">Diagramme circulaire des articles</h5>
		<p style="color:white">Quantité de stock par catégorie</p>
		<div>
	...
	<h3 class="page-title">Rapport des utilisateurs</h3>
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		<h5 style="color:white">Histogramme des utilisateurs</h5>
		<p style="color:white">Nouvelles inscriptions au cours des 30 derniers jours</p>
		<div>
		...
		?>
		<h4 style="color:white">Nombres de nouvelles inscriptions au cours des 30 derniers jours: <?php echo $quantity_user?> utilisateur/utilisateurs</h4>
	</div>
</div>
<script>
