          ...
          <table class="responsive-table">
            <tbody>
              <?php
                ...
                if ($displayShipping === 0) $displayShipping = "<span class='underline'>EURO$displayShipping</span>";
                else $displayShipping = "EURO$displayShipping";

                if ($sumTotal >= 2000){
                  $shippingTotal = $sumTotal - 100;
                  $displayPVoucher = "<span class='underline'>-EURO100</span> <span class='yellow-text'>(Promo voucher applied)</span>";
                }
                ...
                echo("<tr><th>Sum Total:</th><td>EURO$sumTotal</td></tr>");
