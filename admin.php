...
<head>
  ...
  <title>OG Tech - Panneau d'Administration</title>
  <?php 
    include "header.php";
        ...
        <div class="col s12 m6">
          <div class="card blue darken-1" style="width: 340px;">
            <div class="card-content white-text" style="height: 160px;">
              ...
              <div class="grid">
                <i class="material-icons white-text">compte superviseur</i>
                <div id="signup">
                  <?php 
            ...
            <div class="card-action left" style="width: 340px;">
              <a href="admin_report.php#user">Voir le rapport</a>
        ...
        <div class="col s12 m6">
          <div class="card amber darken-4" style="width: 340px;"> 
            <div class="card-content white-text" style="height: 160px;">
              ...
              <div class="grid">
                <i class="material-icons white-text">categories</i>
                <?php 
            ...
            <div class="card-action left" style="width: 340px;">
              <a href="admin_report.php#product">Voir le Rapport</a>
              <a href="admin_manage_products.php">Gérer les Produits</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col s12 m6">
          <div class="card green darken-1" style="width: 340px;">
            <div class="card-content white-text" style="height: 160px;">
              ...
              <div class="grid">
                <i class="material-icons white-text">Panier</i>
                <div id="order">
                  <?php 
            ...
            <div class="card-action left" style="width: 340px;">
              <a href="admin_report.php#order">Voir le Rapport</a>
              <a href="admin_view_orders.php">Gérer les Commandes</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style="width: 340px; height: 238px">
        <div class="col s12 m6">
          <div class="card red lighten-1" style="width: 340px;">
            <div class="card-content white-text" style="height: 160px;">
              <span class="card-title">Commandes du Jour</span>
              <div class="grid">
                <div id="order1">
                  <?php 
                    $sql = "SELECT M.*, O.*, P.* FROM Members M, Orders O, Payment P
            ...
            <div class="card-action center">
              <a href="admin_view_orders.php">Gérer</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-content white-text">
              <table class="responsive-table center" id="pagination">
                <thead class="text-primary center">
                  <tr>
                    <h5 class="white-text bold" style="padding-bottom: 20px">Avis sur les Produits</h5>
                  </tr>
                </thead>
                <tbody>
                  <?php 
