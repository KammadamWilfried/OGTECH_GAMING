...
<head>
  ...
  <title>OG Tech PC - Panneau de gestion des produits</title>
  <?php
    include "header.php"; 
...
<body>
  <div class="container" style="margin-top: 150px">
    <h3 class="page-title">Gérer les produits</h3>

    <div class="rounded-card-parent center" style="margin-bottom: 100px">
      <div class="card rounded-card">
        <div class="card-content white-text">
          <span class="orange-text" style="font-size: 24px">Liste des produits - triée par quantité
          <th>
          ...
          <form action="admin_manage_products.php" method="POST">
            <div class="row" style="margin: 0px;">
              <div class="input-field col s3" style = "color:azure">
                ...
                <label for="search_product">Rechercher un produit par nom ou par marque</label>
          ...
          <form action="" method="GET">
            <table class="responsive-table" id="pagination">
              <thead class="text-primary">
                <tr>
                  <th>Nom</th><th>Marque</th><th class='center'>Quantiték</th>
                </tr>
              </thead>
              <tbody>
                <?php
  ...
  <div class="rounded-card-parent">
    <div class="card rounded-card">
      <div class="card-content white-text">
        <span class="card-title orange-text bold">Détails du Produit Sélectionné</span>
        <table class="responsive-table center">
          <form action="admin_manage_products.php" method="GET">
            <thead class="text-primary center">
            <tr><th>Image</th><th>Nom</th><th>Marque</th>
            <th>Description</th><th>Categorie</th><th>Prix de Vente</th><th>Qté en Stock</th></tr>
            </thead>
            <tbody>
              <?php
  ...
  <div class="rounded-card-parent" style="margin-top: 100px">
    <div class="card rounded-card">
      <div class="card-content">
        <span class="card-title orange-text bold">Créer un Produit</span>
            ...
            <div class="col s6" style="padding-right: 40px;">
              <div class="row">
                <div class="input-field white-text">
                  ...
                  <label for="name" class="white-text">Nom du Produit</label>
                </div>
              </div>
              <div class="row">
                <div class="input-field white-text">
                  ...
                  <label for="brand" class="white-text">Marque</label>
                </div>
              </div>
              <div class="row">
                <div class="row">
              ...
              <div class="row">
                <div class="input-field white-text">
                  ...
                  <select name="category" id="category">
                    ...
                    <option value=0>Pack PC</option>
                    <option value=1>Moniteur & Audio</option>
                    <option value=2>Peripheriques</option>
                  </select>
                  <label class="white-text">Categorie</label>
                </div>
              </div>
              <div class="row">
                <div class="input-field white-text">
                  ...
                  <label for="sellingprice" class="white-text">Pric de Ventes</label>
                </div>
              </div>
              <div class="row">
                <div class="input-field white-text">
                  ...
                  <label for="quantityinstock" class="white-text">Quantité en Stock</label>
                </div>
              </div>
            </div>
          </div>
