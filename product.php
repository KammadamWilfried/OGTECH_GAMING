...
<?php 
  ...
  } else die("<h5 class='container white-text page-title' style='margin-top: 50px'>Aucun article sélectionné...</h5>");
?>
...
<div class="container" style="margin-top: 50px;">
  <div class="rounded-card-parent">
    <div class="card rounded-card">
      <a class="btn red darken-2" href="product_catalogue.php?query=" style='margin-left: 20px'>< RETOUR AU CATALOGUE</a>
        ...
        <div class="row">
          ...
          <div class="col s8">
              ...
              <table class="responsive-table">
                <tbody>
                  ...
                  <tr>
                    ...
                    |
                    <?php   
                      if ($hasReviews) echo("$reviewCount avis");
                      else echo("Aucun avis pour le moment");
                    ?>
                    |
                    <?php
                  ...
                  <tr><th class='grey-text'>Marque : </th><td><?php echo($brand); ?></td></tr>
                  ...
                  <tr><th class='grey-text'>Catégorie : </th><td><?php echo($category); ?></td></tr>
                </tbody>
              </table>
            </div>

            <div class="row input-field grid">
              <a style="margin-right: 10px"><p class="grey-text">Quantité :</p></a>          
              ...
              <div id="qtyHolder">
                <?php 
                  if ($quantityInStock < 6) echo("<a class='red-text' style='margin-left: 10px'>$quantityInStock restants !</a>"); 
                  else echo("<a class='grey-text' style='margin-left: 10px'>$quantityInStock en stock</a>");
                ?>
              </div>
            </div>
            <div class="row grid" style="margin-right: 10px">
              ...
              <input class="btn white-text waves-effect amber darken-4" type="submit" name="buy_now" style='margin-left: 10px' value="Acheter maintenant">
            </div>
          </div>
        </div>
      </form>
  ...
  <div class="rounded-card-parent" style="margin-top: 50px;">
    <div class="card rounded-card">
      <h4 class="white-text" style="margin-bottom: 40px;">Avis</h4>
      ...
      <?php
        ...
        } else echo("<h6 class='grey-text'>Aucun avis pour le moment... Soyez le premier à en laisser un !</h6>")
      ?>
    </div>
  </div>
</div>
