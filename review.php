        ...
        <div class="row">
          <div class="col s9">
            <div class="grid left">
              ...
              <h4 class="amber-text bold grid">Évaluer le produit</h4>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12 white-text">
              ...
              <label for="review" class="white-text">Laissez un commentaire</label>
            </div>
            <div class="errormsg">
              <?php
                if (isset($_GET["error"]))
            ...
            <?php
              ...
              {
                if ($_GET["error"] == "none")
                  echo "<p style='color: green; font-weight: bold'>Merci pour votre avis ! Redirection vers le panier...</p>";
              }
            ?>
          </div>
          <div class="container center-align">
            <input class="btn orange" type="submit" name="submit" value="Soumettre l'avis">
          </div>
          </form>
        </div>
      </div>
