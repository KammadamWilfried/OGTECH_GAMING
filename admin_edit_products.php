...
<head>
  ...
  <title>OG Tech PC - Modifier un produit</title>
  <?php
    require "header.php";
...
<body>
  ...
  <div class="card rounded-card">
    <a class="btn blue darken-2" href='admin_manage_products.php' style="margin-bottom: 10px;">< RETOUR À LA GESTION DES PRODUITS</a>
    <span class="card-title orange-text bold center" style="padding-left: 100px;">Modifier le produit - <?php echo $name; ?></span>
          ...
          <div class="row">
            <div class="input-field white-text">
              ...
              <select name="category" id="category">
                ...
                <option value=0>Packs PC</option>
                <option value=1>Moniteurs & Audio</option>
                <option value=2>Périphériques</option>
              </select>
              <label class="white-text">Catégorie</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field white-text">
              ...
              <label for="sellingprice" class="white-text">Prix de vente</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field white-text">
      ...
      <?php
        if (isset($_GET["error"]))
        {
          if ($_GET["error"] == "empty_input")
            ...
            echo "<p class='green-text bold'>Produit modifié avec succès.</p>";
        }
      ?>
    </div>
    <button type="submit" id="update" name="update" class="btn">Mettre à jour le produit</button>
    </form>
  </div>
</div>
</body>
